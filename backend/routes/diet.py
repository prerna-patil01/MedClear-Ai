...
- Structure response as strict JSON only — no markdown, no preamble
...
def extract_findings_text(analysis: dict) -> str:
    """Extract readable text from the analysis object."""
    parts = []
...
Generate a detailed, actionable diet plan that directly addresses the specific conditions and values found in this report. Be specific with food recommendations and portions."""
